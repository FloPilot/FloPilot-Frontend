    ...
    <div className="space-y-5">
        ...
        <div className="space-y-3">
          <div>
            ...
            <p className={cn("mt-0.5", dashboardTaskDetailClass)}>
              This drives receiving and materials checkpoints on the order.
            </p>
          </div>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    selected
                      ? "border-brand-primary/30 bg-brand-primary/[0.04] ring-1 ring-brand-primary/15"
      ...
      {activeItems.length > 0 ? (
        <div className="space-y-2">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-[#8a8a8a]">
            On this order ({activeItems.length})
          </p>
          <div className="space-y-2">
        ...
        <div className="rounded-lg border border-dashed border-[#e3e3e3] bg-[#fafafa] px-4 py-8 text-center">
          <p className="text-[13px] font-medium text-[#303030]">
            No blanks yet — optional
          </p>
          <p className={cn("mx-auto mt-1 max-w-sm", dashboardTaskDetailClass)}>
            Add catalog blanks now, or skip and add garments from the order
            detail page later.
          </p>
        </div>
      )}
      ...
      <div className={cn(dashboardInsetSurfaceClass, "overflow-hidden")}>
        <div className="border-b border-[#ebebeb] bg-[#fafafa] px-4 py-3">
          <p className="text-[13px] font-semibold text-[#303030]">Add blank</p>
          <p className={cn("mt-0.5", dashboardTaskDetailClass)}>
            ...
            <table className="w-full min-w-[520px] text-[13px]">
              ...
              <tfoot>
                <tr className="bg-[#fafafa]">
                  ...
                  >
                    {draftPieceCount} piece{draftPieceCount !== 1 ? "s" : ""} to
                    add
                  </td>
